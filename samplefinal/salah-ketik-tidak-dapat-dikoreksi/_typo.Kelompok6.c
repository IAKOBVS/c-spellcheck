...
htgPTKP()
{
	...
	tanggungan = Zni(tanggungan, 3); /*  Maksimal 3 tanggungan */
...
mnPajak()
{
	char pilihan;
	do {
		long gajiBruto = ZZZZZjiBruot(); /*  Ipt gaji bruto */
		long biayaJabatan = ZZZZZayaiabatan(gajiBruto); /*  Htg biaya jabatan */
		long iuranPns = ZZZZZPnt(); /*  Ipt iuran pensiun */
		long gajiBersih = gajiBruto - biayaJabatan - iuranPns; /*  Htg gaji bersih */

		long ptkp = ZZZZZKP(); /*  Htg PTKP berdasarkan status "Belum Menikah" dan tanggungan */
		long pkp = ZZZZZK(gajiBersih, ptkp); /*  Htg PKP */
		long pajak = ZZZZZjag(pkp); /*  Htg pajak berdasarkan trf */
