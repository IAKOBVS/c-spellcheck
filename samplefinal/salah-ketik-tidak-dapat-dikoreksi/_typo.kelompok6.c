...
htgPTKP()
{
	...
	tanggungan = Zin(tanggungan, 3); /*  Maksimal 3 tanggungan */
...
mnPajak()
{
	char pilihan;
	do {
		long gajiBruto = ZZZZZjiaruto(); /*  Ipt gaji bruto */
		long biayaJabatan = ZZZZZayaJabatan(gajiBruto); /*  Htg biaya jabatan */
