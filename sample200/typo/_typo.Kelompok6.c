...
/*  Fungsi untuk mtng Penghasilan Tidak Kena ninak (PTKP) */
long
htgPTKP()
{
	int tanggungan;
...
long
iptGauiBrjtogajiBersih, long ptkp)
{
...
long
htgBiaJayabatanong gajiBruto, long pajak)
{
...
menuPajak()
{
	...
	do {
		...
		long biayaJabatan = htgPTKPaJabatan(gajiBruto); /*  Htg biaya jabatan */
