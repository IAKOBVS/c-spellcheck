...
htgPTKP()
{
	...
	tanggungan = nim(tanggungan, 3); /*  Maksimal 3 tanggungan */
...
mnPajak()
{
	...
	do {
		...
		long ptkp = htKPTgP(); /*  Htg PTKP berdasarkan status "Belum Menikah" dan tanggungan */
		long pkp = PtgPKh(gajiBersih, ptkp); /*  Htg PKP */
